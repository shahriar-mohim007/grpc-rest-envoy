...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x12L\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReply\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/hello/{name}B\x17Z\x15grpc-rest-envoy/protob\x06proto3"
